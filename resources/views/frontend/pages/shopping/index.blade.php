...
@section('content')
    <div class="container cart">
        <div class="left">
            <div class="list">
                <div class="title">CART INFORMATION</div>
                <div class="list__content">
                    ...
                    <p style="float: right;margin-top: 20px;">
                        <span style="margin-right: 15px;">Total amount purchased {{ number_format($purchaseAmount,0,',','.') }} đ</span>
                        <span style="margin-right: 15px;">Percent discount : {{ $discount }}%</span>
                        Total amount : <b id="sub-total">{{ \Cart::subtotal(0) }} đ</b></p>
                </div>
            </div>
        </div>
        <div class="right">
