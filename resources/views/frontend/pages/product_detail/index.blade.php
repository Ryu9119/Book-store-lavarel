    ...
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li>
                    <a itemprop="url" href="{{ route('get.product.list') }}" title="Product"><span
                            itemprop="title">Product</span></a>
                </li>
                    ...
                    <div class="right__content">
                        <div class="info" style="width: 500px">
                            @if ( $product->pro_number <= 0 )
                                <p class="text-danger" style="font-size: 14px;margin-bottom: 5px;background: #dedede;padding: 5px;">Product is out of stock</p>
                            @endif
                            <div class="prices">
                                @if ($product->pro_sale)
                                    <p>Listed price :
                                ...
                                @else
                                    <p>
                                        Product selling price : <span class="value price-new">{{  number_format($product->pro_price,0,',','.') }} $</span>
                                    </p>
                                @endif
                                <p>
                                    <span>View :&nbsp</span>
                            ...
                            <div class="infomation">
                                <h2 class="infomation__title" style="font-weight: bold">Description</h2>
                                <div class="infomation__group">
                                    {!! $product->pro_description !!}
                                </div>
                                <h2 class="infomation__title" style="font-weight: bold">Information</h2>
                                <div class="infomation__group">
...
{{--                            @include('frontend.pages.product_detail.include._inc_keyword')--}}
                        ...
                        <div class="ads">
                            <a href="#" title="Discount" target="_blank">
            ...
            <div class="tab-content" style="margin-bottom: 10px;">
                <ul class="nav" style="margin-bottom: 15px;padding-top: 10px;">
                    <li><a href="" class="tab-item active" data-id="#tab-content">Content</a></li>
                    <li><a href="" class="tab-item" data-id="#tab-rating">Rating</a></li>
                </ul>
                ...
                <div class="form-comment">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            <textarea placeholder="Please leave a comment ..." name="comment" class="form-control" id="" cols="30" rows="5"></textarea>
                        </div>
                        <div class="footer">
                            <p>
                                <a href=""><i class="la la-camera">Send photos</i> </a>
                                <a href="">Rules for posting comments</a>
                            </p>
                            <button class=" {{ \Auth::id() ? 'js-save-comment' : 'js-show-login' }}">Post a comment</button>
                        </div>
                    </form>
                </div>
        ...
        <div class="card-body product-des">
            ...
            <div class="right">
                <a href="#" title="" target="_blank">
                    <img alt="" style="width: 100%" src="{{ isset($event3) ? pare_url_file($event3->e_banner) : asset('images/banner/detail_banner_bottom.jpg') }}">
                </a>
            </div>
        </div>
    </div>
