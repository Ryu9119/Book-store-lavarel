...
@section('content')
    ...
    <div class="container" id="before-slide">
        <div class="product-one">
            <div class="top">
                <a href="#" title="" class="main-title main-title-2" style="text-transform: uppercase;">Selling products</a>
            </div>
            <div class="bot">
                @if ($event1)
                    <div class="left">
        ...
        <div class="product-one">
            <div class="top">
                <a href="#" title="" class="main-title main-title-2" style="text-transform: uppercase;">New product</a>
            </div>
            <div class="bot">
                <div class="left">
                    <div class="image">
        ...
        <div class="product-two">
            <div class="top">
                <a href="#" class="main-title main-title-2" style="text-transform: uppercase;">Featured products</a>
            </div>
            <div class="bot">
