        ...
        <form action="{{ route('payment.online') }}" id="create_form" method="post">
            ...
            <div class="form-group">
                ...
                <select name="order_type" id="order_type" class="form-control" required>
                    <option value="topup">Recharge your phone</option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2" placeholder="Content billing" required></textarea>
            </div>
            ...
            <button type="submit" class="btn btn-primary" id="btnPopup">Payment confirmation</button>
