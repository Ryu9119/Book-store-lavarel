                                ...
                                @if (isset($users))
                                    @foreach($users as $key => $user)
                                        <tr>
                                            ...
                                            <td>{{ $user->phone }}</td>
                                            <td>
                                                <a href="{{ route('admin.user.transaction', $user->id) }}" class="btn btn-xs btn-primary js-show-transaction"> Debts to be collected</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Debts to be collected from customers</h4>
                </div>
