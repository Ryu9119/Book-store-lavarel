...
@section('content')
        ...
        <div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="info-box">
					...
					<div class="info-box-content">
						<span class="info-box-text">Daily turnover</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Annual revenue</span>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Top selling products in the month</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        </button>
                        <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                ...
                <!-- /.box-body -->
                <div class="box-footer clearfix">
                    <a href="{{ route('admin.product.index') }}" class="btn btn-sm btn-info btn-flat pull-right">List of products</a>
                </div>
                <!-- /.box-footer -->
            </div>
            <!-- /.box -->
        ...
        <div class="col-md-4">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Top products viewed more</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        </button>
                        <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
...
<link rel="stylesheet" href="https://code.highcharts.com/css/highcharts.css">
    ...
    <script type="text/javascript">
        ...
        Highcharts.chart('container2', {
            ...
            title: {
                text: 'Revenue chart of the days of the month'
            },
            subtitle: {
