                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <select name="c_parent_id" class="form-control" id="">
                                    <option value="0">__Selected_</option>
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body block-images">
                                    ...
                                    <div style="position:relative;">
                                        <a class="btn btn-primary" href="javascript:;"> Select image... <input type="file" style="position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:&quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=0)&quot;;opacity:0;background-color:transparent;color:transparent;" name="c_avatar" size="40" class="js-upload"> </a> &nbsp; <span class="label label-info" id="upload-file-info"></span> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
