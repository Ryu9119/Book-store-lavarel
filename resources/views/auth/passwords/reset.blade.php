        ...
        <div class="auth" style="background: white;">
            <form class="from_cart_register" action="" method="post" style="width: 500px;margin:0 auto;padding: 30px 0">
                ...
                <div class="form-group">
                    <label for="name">A new password <span class="cRed">(*)</span></label>
                ...
                <div class="form-group">
                    <label for="name">Confirm password <span class="cRed">(*)</span></label>
                ...
                <div class="form-group">
                    <button class="btn btn-purple btn-xs">Change new password</button>
                </div>
            </form>
        </div>
    </div>
